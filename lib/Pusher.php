...
class Pusher
{
    ...
    private function check_compatibility()
    {
        if (!extension_loaded('curl') || !extension_loaded('json')) {
            throw new PusherException('There is missing dependant extensions - please ensure cURL module are installed');
        }
        if (!extension_loaded('json')) {
            throw new PusherException('\n There is missing dependant extensions - please ensure JSON module are installed');
        }
